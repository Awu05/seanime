...
function Content() {
    ...
    useWebsocketMessageListener<DownloadProgress>({
        ...
        onMessage: progress => {
            ...
            // Refresh the local-downloads list when a download completes so the badge
...
const TorrentItem = React.memo(function TorrentItem({ torrent, isPending, isDownloadedLocally, downloadProgress }: TorrentItemProps) {
    ...
    return (
        ...
        >
            ...
            <div className="flex-none flex gap-2 items-center">
                ...
                {(torrent.isReady && !isDownloadingLocally) && <>
                    <Tooltip trigger={
                        <IconButton
