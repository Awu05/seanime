...
export const API_ENDPOINTS = {
    ADMIN_PROFILES: {
         ...
         *  Profile owner or admin can update.
         */
        UpdateProfileName: {
            key: "ADMIN-PROFILES-update-profile-name",
            methods: ["POST"],
    ...
    DEBRID: {
         ...
         *  When playLocally is true, streams from the downloaded local file instead
         *  of re-fetching the debrid URL. The local file is resolved from the
         *  DebridLocalDownload record for the given torrent id.
         */
        DebridPlayTorrent: {
            key: "DEBRID-debrid-play-torrent",
            methods: ["POST"],
            endpoint: "/api/v1/debrid/torrents/play",
        },
        /**
         *  @description
         *  Route list debrid torrents that have been downloaded locally.
         *  Used by the debrid page to show a "downloaded" indicator on torrents.
         */
        DebridGetLocalDownloads: {
            key: "DEBRID-debrid-get-local-downloads",
            methods: ["GET"],
         ...
         *  Removes the downloaded files from the local path and clears the DB record.
         *  The remote debrid torrent is NOT removed — use HandleDebridDeleteTorrent for that.
         */
        DebridDeleteLocalDownload: {
            key: "DEBRID-debrid-delete-local-download",
            methods: ["DELETE"],
